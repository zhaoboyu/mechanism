...
- (void)createSubviews{
    self.picAmov = [[UIImageView alloc]initWithFrame:CGRectMake(30*scaleW, 159*scaleH-64, 36*scaleW, 28*scaleH)];
    [self.contentView addSubview:_picAmov];
    
    self.contentLabel = [[UILabel alloc]initWithFrame:CGRectMake(76*scaleW, 159*scaleH-64, 360*scaleW, 30*scaleH)];
    self.contentLabel.font = [UIFont systemFontOfSize:15];
    self.contentLabel.textColor = [UIColor colorWithHexString:@"#4a4a4a"];
    [self.contentView addSubview:_contentLabel];
    
    self.iconPic = [[UIImageView alloc]initWithFrame:CGRectMake(30*scaleW, 210*scaleH -64, 40*scaleW, 40*scaleH)];
    [self.contentView addSubview:_iconPic];
    
    self.nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(80*scaleW, 215*scaleH-64, 86*scaleW, 28*scaleH)];
    self.nameLabel.font = [UIFont systemFontOfSize:14];
    self.nameLabel.textColor =[UIColor colorWithHexString:@"#000000"];
    [self.contentView addSubview:_nameLabel];
    
    self.timeLabel = [[UILabel alloc]initWithFrame:CGRectMake(196*scaleW, 215*scaleH - 64, 165*scaleW, 28*scaleH)];
    ...
    guanliBtn.frame = CGRectMake(480*scaleW, 179*scaleH -64, 130*scaleW, 50*scaleH);
    ...
    deleBtn.frame = CGRectMake(630*scaleW, 179*scaleH -64, 100*scaleW, 50*scaleH);
