...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"ForgetCodeNext"]) {
        ForgetCodeNext *vc = segue.destinationViewController;
        vc.account = _acountText.text;
